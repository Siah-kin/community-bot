...
## 🤝 Human-AI Cooperation Manifesto

**This document exists because AI is a tool, not a replacement.**

The goal isn't to hide that AI helped. The goal is to ensure a human shaped the output. AI generates, humans curate. The fingerprint of cooperation should be visible in the quality, not hidden behind a facade.

### Why This Matters

Generic AI output has tells:
- Everything sounds "professional" in the same flat way
- Sentences stack benefits robotically
- No personality, no risk, no edge
- Overly balanced, afraid to take a stance

Human-guided AI output has:
- Deliberate imperfection (a short sentence. then a long one that builds on it)
- Opinions that might alienate some readers (that's fine, we're not for everyone)
- Specific numbers instead of "significant improvement"
- Inside jokes, cultural references, personality

### The Cooperation Test

Before shipping, ask: "Could this have been generated by someone who pasted 'write me a landing page' into ChatGPT?"

If yes, it needs more human fingerprints:
- Add a specific story or example only you know
- Take a stance that requires courage
- Include a detail that proves you actually use the product
- Break a "rule" intentionally for effect

### Current AI Fingerprints to Avoid (v3 - Jan 2026)

These patterns scream "unedited AI output":

**Structural tells:**
- Em-dashes cramming two ideas together—like this—when a period works better
- "With [benefit] and [benefit]" stacking in every sentence
- Exactly three bullet points (AI loves threes)
- Every section the same length (humans are messier)
- Conclusion that restates the intro (lazy loop)

**Word tells:**
- "Leverage," "utilize," "facilitate" (just say use)
- "Comprehensive," "robust," "cutting-edge" (empty adjectives)
- "Seamlessly," "effortlessly" (nothing is effortless)
- "Revolutionize," "transform," "game-changing" (prove it with numbers)
- "In today's fast-paced world" (delete this forever)
- "Whether you're a... or a..." (false inclusivity)

**Tone tells:**
- Relentlessly positive (humans have doubts, share them)
- Never says "I don't know" or "this might not work for you"
- Treats reader like they need hand-holding
- No humor, no edge, no personality

### Human Fingerprints to Add

**Prove you're real:**
- "We tried X, it failed, here's what we learned"
- Specific dates, versions, commit hashes
- Screenshots with your actual UI, not stock mockups
- Admitting limitations before the reader finds them

**Show personality:**
- A metaphor that only makes sense if you know the product
- Reference to team inside jokes (sparingly)
- Sentence fragments. For emphasis.
- Starting a sentence with "And" or "But" (AI is trained not to)

**Take risks:**
- "This isn't for everyone. If you want X, try [competitor]."
- Strong opinions: "We think Y is wrong, here's why"
- Incomplete information: "We're still figuring out Z"

### Version History

This section evolves as AI patterns change:

- **v3 (Jan 2026):** Added "whether you're a... or a..." pattern, expanded word tells
- **v2 (Dec 2025):** Added structural tells, three-bullet pattern
- **v1 (Nov 2025):** Initial fingerprint list

**Maintainer responsibility:** Update this quarterly as AI outputs evolve. The goal is staying ahead, not catching up.
