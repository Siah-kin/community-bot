# BonziVista Public Roadmap

Last reviewed: 2026-06-25

This file is the source for the public WHEN page. It translates the live Bonzi_v5 masterplan into community-facing language. The live position comes from `data/oracle_state.json`; the older archived masterplan is used only for phase order, not for completion percentages.

## Short-term

The first features work. Right now we are proving they hold up with real use before adding more.
...
This stretch turns working pieces into proof people can inspect.
